 ...
 *
 * Displays list of test data sheets in the sidebar.
 */

import { FileSpreadsheet, MoreVertical, Edit2, Trash2, RefreshCw } from 'lucide-react';
        ...
        <div className="flex-1 overflow-y-auto">
            {loading ? (
                ...
                <div className="px-4 py-8 text-center text-slate-500 text-sm">
                    ...
                    <p>No test data sheets yet</p>
                    <p className="text-xs mt-1">Create a sheet or import from Excel</p>
                </div>
            ) : (
                <div className="py-2">
                    {sheets.map(sheet => (
