...
export function registerVeroLanguage(monaco: Monaco): void {
    ...
    monaco.editor.defineTheme('vero-intellij-dark', {
        base: 'vs-dark',
        inherit: true,
        rules: [
            { token: 'comment', foreground: '7A7E85', fontStyle: 'italic' },
            { token: 'tag', foreground: 'CC7832', fontStyle: 'bold' },
            { token: 'string', foreground: '6AAB73' },
            { token: 'number', foreground: '2AACB8', fontStyle: 'bold' },
            { token: 'keyword.structure', foreground: 'CC7832', fontStyle: 'bold' },
            { token: 'keyword.hook', foreground: 'CC7832', fontStyle: 'bold' },
            { token: 'keyword.control', foreground: 'CC7832', fontStyle: 'bold' },
            { token: 'keyword.operator', foreground: 'CC7832', fontStyle: 'bold' },
            { token: 'type.selector', foreground: '2AACB8', fontStyle: 'bold' },
            { token: 'function.action', foreground: 'FFC66D' },
            { token: 'keyword.assertion', foreground: 'CC7832', fontStyle: 'bold' },
            { token: 'constant.condition', foreground: 'CC7832', fontStyle: 'bold' },
            { token: 'type', foreground: '2AACB8', fontStyle: 'bold' },
            { token: 'type.identifier', foreground: 'BCBEC4' },
            { token: 'variable.name', foreground: '9876AA' },
            { token: 'identifier', foreground: 'BCBEC4' },
            { token: 'keyword.vdql', foreground: 'BBB529', fontStyle: 'bold' },
            { token: 'keyword.vdql.operator', foreground: 'BBB529' },
            { token: 'function.vdql', foreground: 'BBB529', fontStyle: 'bold' },
            { token: 'operator.vdql', foreground: 'CC7832' },
            { token: 'variable.vdql.table', foreground: '2AACB8', fontStyle: 'bold' },
            { token: 'variable.vdql.name', foreground: '9876AA' },
            { token: 'function.utility.string', foreground: 'FFC66D', fontStyle: 'bold' },
            { token: 'function.utility.date', foreground: '6AAB73', fontStyle: 'bold' },
            { token: 'function.utility.number', foreground: '2AACB8', fontStyle: 'bold' },
            { token: 'function.utility.generate', foreground: '9876AA', fontStyle: 'bold' },
        ],
        colors: {
            ...
            'editorLineNumber.foreground': '#4B4D53',
            'editorLineNumber.activeForeground': '#A9B0B7',
