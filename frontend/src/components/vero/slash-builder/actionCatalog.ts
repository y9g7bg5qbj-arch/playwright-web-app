...
export const ACTION_CATALOG: ActionDef[] = [
    ...
    // ========================================================================
    {
        id: 'hook-before-all',
        label: 'BEFORE ALL',
        keywords: ['BEFORE', 'ALL', 'HOOK', 'SETUP'],
        template: 'BEFORE ALL {\n}',
        snippetTemplate: 'BEFORE ALL {\n    \n}',
        category: 'control',
        description: 'Run setup once before all scenarios in the feature',
        slots: [],
    },
    {
        id: 'hook-before-each',
        label: 'BEFORE EACH',
        keywords: ['BEFORE', 'EACH', 'HOOK', 'SETUP'],
        template: 'BEFORE EACH {\n}',
        snippetTemplate: 'BEFORE EACH {\n    \n}',
        category: 'control',
        description: 'Run setup before every scenario in the feature',
        slots: [],
    },
    {
        id: 'hook-after-each',
        label: 'AFTER EACH',
        keywords: ['AFTER', 'EACH', 'HOOK', 'TEARDOWN'],
        template: 'AFTER EACH {\n}',
        snippetTemplate: 'AFTER EACH {\n    \n}',
        category: 'control',
        description: 'Run teardown after every scenario in the feature',
        slots: [],
    },
    {
        id: 'hook-after-all',
        label: 'AFTER ALL',
        keywords: ['AFTER', 'ALL', 'HOOK', 'TEARDOWN'],
        template: 'AFTER ALL {\n}',
        snippetTemplate: 'AFTER ALL {\n    \n}',
        category: 'control',
        description: 'Run teardown once after all scenarios in the feature',
        slots: [],
    },
    {
        id: 'for-each',
