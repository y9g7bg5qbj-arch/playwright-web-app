/**
 * Managed Vero IDE workflow template.
 *
 * This YAML is pushed to user repositories when they set up
 * GitHub Actions as their execution target. All runtime settings
 * (browser, workers, retries, etc.) are passed as dispatch inputs
 * so a single file serves every run configuration.
 */

/** Fixed path where the managed workflow file lives. */
export const VERO_MANAGED_WORKFLOW_PATH = '.github/workflows/vero-tests.yml';

/** Semver-style version stamped in the YAML header comment. */
export const VERO_WORKFLOW_TEMPLATE_VERSION = '1.1.0';

/** Full YAML content to be committed to the user's repository. */
export const VERO_WORKFLOW_TEMPLATE = `# Auto-generated by Vero IDE v${VERO_WORKFLOW_TEMPLATE_VERSION} — do not edit manually
  ...
  workflow_dispatch:
    inputs:
      ...
      veroContentB64:
        ...
        default: ''
        type: string
      veroReferencedContentB64:
        description: 'Base64-encoded referenced Vero content (Pages/PageActions)'
        required: false
        default: ''
        type: string
      retries:
    ...
    steps:
      ...
      - name: Run Vero tests (IDE mode)
        ...
        env:
          ...
          VERO_REFERENCED_CONTENT_B64: \${{ inputs.veroReferencedContentB64 }}
