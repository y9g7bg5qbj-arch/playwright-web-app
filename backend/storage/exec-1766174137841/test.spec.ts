...
test('generated flow', async ({ page, context }) => {
  ...
  await page.screenshot({ path: '/Users/mikeroy/Downloads/Telegram Desktop/playwright-web-app/backend/storage/exec-1766174137841/screenshots/step-1.png', fullPage: false });
  ...
  await page.screenshot({ path: '/Users/mikeroy/Downloads/Telegram Desktop/playwright-web-app/backend/storage/exec-1766174137841/screenshots/step-2.png', fullPage: false });
  ...
  await page.screenshot({ path: '/Users/mikeroy/Downloads/Telegram Desktop/playwright-web-app/backend/storage/exec-1766174137841/screenshots/step-3.png', fullPage: false });
